...
class ExcelControl:
    def __init__(self, excel_path, sheet_name):
        ...
        # Get excel workbook in data only mode
    ...
    def add_to_excel(self, cell: str, value: str):
        ...
        # Assign value provided to the cell provided
        self.sh[cell].value = value
    ...
    def delete_from_excel(self, row_count: int):
        ...
        """
        self.sh.delete_rows(
            row_count)  # Delete the row provided from the excel
        self.wb.save(self.excel_path)  # Finally, save the excel file
